...
public class RestClientMtbSender {
  ...
  public String sendRequestToMtb(OnkostarDaten onkostarDaten) throws JacksonException {
    ...
    ByteArrayResource xmlResource =
        new ByteArrayResource(xmlOnkostarDaten.getBytes()) {
          @Override
    ...
    try {
      var response =
          retryTemplate.execute(
              ctx -> restTemplate.exchange(postUrl, HttpMethod.POST, requestEntity, String.class));

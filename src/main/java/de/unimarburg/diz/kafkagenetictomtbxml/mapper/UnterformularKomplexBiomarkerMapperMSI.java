...
public class UnterformularKomplexBiomarkerMapperMSI {
  ...
  public UnterformularKomplexBiomarkerMapperMSI(
  ...
  public UnterformularKomplexBiomarker createXmlUnterformularKBiomarkerMSI(
    ...
    unterformularKBiomarker.setEintraege(
        Arrays.asList(
            analyseMethoden, assay, ergebnisEintragSV, komplexerBiomarker, seqProzentwert));

...
public class UnterformularKomplexBiomarkerMapperTMB {
  ...
  public UnterformularKomplexBiomarkerMapperTMB(
      final MetadataConfigurationProperties metadataConfigurationProperties) {
    this.metadataConfigurationProperties = metadataConfigurationProperties;
  }

  public UnterformularKomplexBiomarker createXmlUnterformularKBiomarkerTMB(
    ...
    unterformularKBiomarker.setEintraege(
        Arrays.asList(analyseMethoden, assay, komplexerBiomarker, komplexerBiomarkerTMB));

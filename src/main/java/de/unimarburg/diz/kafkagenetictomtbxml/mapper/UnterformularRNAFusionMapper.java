...
public class UnterformularRNAFusionMapper {
  ...
  public String extractStringFromJson(String jsonAnotation, String keyToExtract)
  ...
  public UnterformularRNAFusion createXmlUnterformularRANFusion(
      MtbPatientInfo mtbPatientInfo,
      Variant variant,
      DokumentierendeFachabteilung dokumentierendeFachabteilung,
      int startExportIDUNterformular)
      throws JsonProcessingException {
    UnterformularRNAFusion unterformularRNAFusion = new UnterformularRNAFusion();
    // To find the export ID a function need to implement, that track the number of unterformular
    // and add the number TODO
    ...
    ergebnisEintragRNAFusion.setFilterkategorie(
        "{&quot;OS.MolGenErgebnis.v1&quot;:&quot;Standard&quot;}");
    ...
    fusionRNA3ExonID.setWert(
        extractStringFromJson(variant.getAnnotationJson(), "MH_EXON_NUMBER_2"));
    ...
    fusionRNA3Strand.setWert(
        extractStringFromJson(variant.getAnnotationJson(), "SEGMENT_2_ALIGNMENT_STRAND"));
    ...
    fusionRNA5ExonID.setWert(
        extractStringFromJson(variant.getAnnotationJson(), "MH_EXON_NUMBER_1"));
    ...
    fusionRNA5Strand.setWert(
        extractStringFromJson(variant.getAnnotationJson(), "SEGMENT_1_ALIGNMENT_STRAND"));
    ...
    fusionRNA5TranscriptID.setWert(
        extractStringFromJson(variant.getAnnotationJson(), "SEGMENT_1_DISPLAY_TRANSCRIPT_ID"));
    ...
    unterformularRNAFusion.setEintraege(
        Arrays.asList(
            aktivierend,
            allelfrequenz,
            allelzahl,
            ...
            bemerkung,
            datumFusion,
            ergebnisEintragRNAFusion,
            fusionArt,
            fusionRNA3ENSEMBLID,
            fusionRNA3ExonID,
            fusionRNA3HGNCID,
            fusionRNA3HGNCName,
            fusionRNA3HGNCSymbol,
            fusionRNA3Strand,
            fusionRNA3TransPosition,
            fusionRNA3TranscriptID,
            fusionRNA5ENSEMBLID,
            fusionRNA5ExonID,
            fusionRNA5HGNCID,
            fusionRNA5HGNCName,
            fusionRNA5HGNCSymbol,
            fusionRNA5Strand,
            fusionRNA5TransPosition,
            fusionRNA5TranscriptID,
            fusionRNACosmicID,
            fusionRNAEffect,
            fusionRNAReportedNumRead,
            fusioniertesGen,
            untersucht,
            exon,
            exonInt,

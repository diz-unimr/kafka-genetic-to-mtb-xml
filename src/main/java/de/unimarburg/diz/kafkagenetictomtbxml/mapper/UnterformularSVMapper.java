...
public class UnterformularSVMapper {
  ...
  public UnterformularSVMapper(HgncConfigurationProperties hgncConfigurationProperties) {
  ...
  public UnterformularSV createXmlUnterformularSV(
    ...
    if (null != variant.getTranscriptHgvsModifiedObject()
        && !variant.getTranscriptHgvsModifiedObject().isBlank()) {

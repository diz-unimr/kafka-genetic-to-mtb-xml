...
public class JsonUtils {
    ...
    public static <T> T extractFromJson(String jsonString, String keyToExtract, Class<T> clazz) throws JsonProcessingException {
        ...
        throw new IllegalArgumentException(String.format("Cannot get '%s' as '%s'", keyToExtract, clazz.getSimpleName()));
    }
